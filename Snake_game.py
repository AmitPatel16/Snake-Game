...
sb.ht()
sb.goto(-250,-250)
sb.write("score:0 | Hightest Score: 0")
...
#main loop
while True:
   s.update() #this ia update to screen
   #cheak collission wih border
   if head.xcor()>290:
      head.setx(-290)
   if head.xcor()<-290:
      head.setx(290)
...
#cheak collision with food 
   if head.distance(food)<20:
      #move the food to new randon place
...
#this is the end of snake game code------
